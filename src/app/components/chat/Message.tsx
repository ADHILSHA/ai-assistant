...
function MessageComponent({ role, content, onSpeakMessage, isSpeaking }: MessageProps) {
      ...
      >
        ...
        >
          <ReactMarkdown
            ...
            components={{
              h1: ({...props}: MarkdownComponentProps) => <h1 className="text-lg font-bold mt-3 mb-2" {...props} />,
              h2: ({...props}: MarkdownComponentProps) => <h2 className="text-base font-bold mt-3 mb-2" {...props} />,
              h3: ({...props}: MarkdownComponentProps) => <h3 className="text-sm font-bold mt-2 mb-1" {...props} />,
