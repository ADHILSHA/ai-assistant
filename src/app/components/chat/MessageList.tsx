...
export default function MessageList({ messages, isLoading, onSelectPrompt }: MessageListProps) {
  ...
  return (
    <div className="flex flex-col h-full max-h-full overflow-hidden bg-gray-50" style={{ backgroundColor: 'var(--background)' }}>
      ...
      >
        ...
        {isLoading && (
          <div className="flex justify-start">
            <div className="max-w-xs md:max-w-md lg:max-w-lg px-4 py-2 rounded-lg shadow bg-white text-gray-800 border border-gray-200" style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)', color: 'var(--foreground)' }}>
