      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full">
        {promptOptions.map((option, index) => (
          <button
            ...
            className="flex cursor-pointer items-center p-3 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-200 transition-colors text-left shadow-sm bg-white"
          >
